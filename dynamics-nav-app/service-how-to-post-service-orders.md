...
6. Bucht mehrere Servicegutschriften gleichzeitig. führen Sie die Stapelverarbeitung **Servicegutschriften stapelbuchen** aus. Dies kann ein Vorteil sein, wenn Sie eine große Anzahl von Verkaufsgutschriften haben, die gebucht werden müssen.  
  
> [!NOTE]  
>  Es ist wichtig, alle notwendigen Daten in die Gutschriften einzugeben, bevor die Stapelbuchung durchgeführt wird. Ansonsten ist es möglich, dass sie nicht gebucht werden. Sind die Buchungen durch den Batchauftrag abgeschlossen, zeigt eine Meldung an, wie viele der Servicegutschriften gebucht worden sind.  
