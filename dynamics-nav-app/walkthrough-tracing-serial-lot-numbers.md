...
Für die ersten beiden Aufgaben der Defektverwaltung wird das Fenster **Artikelablaufverfolgung** verwendet. Die letzte Aufgabe wird im Fenster **Navigate** durchgeführt, wobei die Ergebnisse aus dem Fenster **Artikelablaufverfolgung** integriert werden.  
...
3.  Geben Sie im Feld **Nr.** Geben Sie im Feld **2000** ein und füllen Sie dann die folgenden Felder aus.  
    ...
    |Beschreibung|Basiseinheitencode|Produktbuchungsgruppe|MwSt.-Produktbuchungsgruppe|Lagerbuchungsgruppe|Artikelverfolgungscode|  
    |-----------------|--------------------------|------------------------------|-----------------------------|-----------------------------|------------------------|  
...
7.  Geben Sie im Feld **Nr.** Geben Sie im Feld **1002** ein und füllen Sie dann die folgenden Felder aus.  
    ...
    |Beschreibung|Basiseinheitencode|Produktbuchungsgruppe|MwSt.-Produktbuchungsgruppe|Lagerbuchungsgruppe|Beschaffungsmethode|Artikelverfolgungscode|  
    |-----------------|--------------------------|------------------------------|-----------------------------|-----------------------------|--------------------------|------------------------|  
